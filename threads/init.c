...
#else
/* project #1 */
#include "projects/1/synctest.h"
#include "projects/2/alloctest.h"
#endif
#ifdef FILESYS
...
int main (void)
{
	...
	/* SimHongSub : Add source to calculate page size */
  	printf("Pintos default page size : %d\n", PGSIZE);
